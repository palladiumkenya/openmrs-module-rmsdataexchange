...
public class PaymentAttributeType {
    ...
    public CashierPaymentAttributeType() {}

    // Constructor with required fields
    public CashierPaymentAttributeType(String name, String description, String format, 
            Integer creator, Boolean searchable) {
        this.name = name;
    ...
    public String toString() {
        return "CashierPaymentAttributeType{" +
